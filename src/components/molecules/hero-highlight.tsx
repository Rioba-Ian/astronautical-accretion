...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "bg-white dark:bg-black group relative flex h-[40rem] w-full items-center justify-center sm:h-[72vmin]",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-indigo-300 to-purple-300 px-1 pb-1 dark:from-pink-500 dark:to-pink-700`,
        className
      )}
    >
      {children}
